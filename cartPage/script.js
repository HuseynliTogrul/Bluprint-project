...
fetchedCartItems.forEach((item, index, array) => {
    let priceContent = "";
    ...
    cartList.innerHTML += `<div class="flex gap-5 h-96 min-w-fit">
        ...
        <div class="flex gap-5">
            <div
            class="h-8 w-8 border flex items-center justify-center rounded-full cursor-pointer ${item.color === "black" ? "bg-color" : `bg-${item.color}-500`}"
            ></div>
            <div
        ...
        <div>
            ...
            >${priceContent} AZN |
            <span class="font-black">${item.price} AZN</span></span
            >
        </div>
        <div>
